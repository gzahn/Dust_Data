...
# paths
maarjam_ssu <- "./taxonomy/maarjam_database_SSU_2021.fasta"
maarjam_ssu_type <- "./taxonomy/maarjam_database_SSU_TYPE_2021.fasta"
maarjam_its <- "./taxonomy/maarjam_database_full_ITS_2021.fasta"
...
its_vtx <- its_headers %>% str_extract("VTX.*")
...
writeFasta(ssu,"./taxonomy/maarjam_database_SSU_2021_newheaders.fasta")
writeFasta(ssu_type,"./taxonomy/maarjam_database_SSU_TYPE_2021_newheaders.fasta")
writeFasta(its,"./taxonomy/maarjam_database_full_ITS_2021_newheaders.fasta")
